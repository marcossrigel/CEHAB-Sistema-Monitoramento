...
<div class="container">
  <div class="header">
    ...
    <div class="button-group">
      <button href="#" type="submit" onclick="window.location.href='?page=crono';" class="btn">Criar Iniciativa</button>
      <button href="#" type="submit" onclick="window.location.href='?page=visualizar';" class="btn btn-secondary">Minhas Vistorias</button>
